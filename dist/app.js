        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("Error fetching config: ".concat(response.statusText));
                    }
...
function fetchGeoTiffFromServer(apiKey, address) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, rasters, width, height, bounds;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, { width: width, height: height, rasters: rasters, bounds: bounds }];
            }
        });
    });
}
function renderRGB(rgb, mask) {
    ...
    var dw = rgb.width / canvas.width;
    var dh = rgb.height / canvas.height;
    var ctx = canvas.getContext('2d');
    var img = ctx.getImageData(0, 0, canvas.width, canvas.height);
    for (var y = 0; y < canvas.height; y++) {
        for (var x = 0; x < canvas.width; x++) {
            var rgbIdx = Math.floor(y * dh) * rgb.width + Math.floor(x * dw);
            var maskIdx = y * canvas.width + x;
            var imgIdx = y * canvas.width * 4 + x * 4;
...
function displayGeoTiff() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, apiKey, address, geoTiff, canvas;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, fetchConfig()];
                case 1:
                    _a = _b.sent(), apiKey = _a.apiKey, address = _a.address;
                    return [4 /*yield*/, fetchGeoTiffFromServer(apiKey, address)];
                case 2:
                    geoTiff = _b.sent();
                    canvas = renderRGB(geoTiff);
